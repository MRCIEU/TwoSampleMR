...
#' @export
#' @return data frame.
format_mr_results <- function(mr_res, exponentiate=FALSE, single_snp_method="Wald ratio", multi_snp_method="Inverse variance weighted", ao_slc=T,by="category")
{
...
#' @export
#' @return data frame.
Sort.1.to.many<-function(mr_res,Trait.var="exposure",Sort.var1="subcategory",Sort.var2="b",Sort1.decreasing = F,Sort2.decreasing=F){
	...
	# mr_res[order(Letters0),c("outcome","subcategory")]
	mr_res<-mr_res[order(Letters0),]

	# mr_res[order(Letters0),c("Method","outcome","b","Trait")]
...
forest_plot <- function(mr_res, exponentiate=FALSE, single_snp_method="Wald ratio", multi_snp_method="Inverse variance weighted", threshold=NULL, xlab="", xlim=NULL, trans="identity",ao_slc=T,Lo=Lo,Up=Up,ncols=1,var1="outcome",var2="",var3="",var4="",width1=1,width2=1,width3=1,width4=1,by=by)
{
	requireNamespace("ggplot2", quietly=TRUE)

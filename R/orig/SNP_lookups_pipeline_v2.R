...
#setwd("/projects/MRC-IEU/users/ph14916/MR/Carolina") 
...
trait="telomeres"
instruments.file="data/telomere_instruments_avivMay2015.txt"
snp.exposure<-"SNPs"
effect="beta"
se="se"
...
find_r2_allele_freq_1k_function(trait=trait,instruments.file=instruments.file,
...
#############
source("/home/ph14916/MR/R/snplookups_function_v6.R")
#databases.excl<-c("ImmuneCellScience","metabolome") # exclude these databases to speed things up
databases.excl<-c("icbp003588" ,"icbp003589" , "icbp003590"  ,"icbp003591") #exclude ICBP because betas are absolute betas
...
snp.lookups(outcome.database="GTEx",trait=trait,snp.exposure=snp.exposure,trait.col=trait.col,effect=effect,se=se,chr_id="chr_name",chr_pos="chrom_start",eaf.trait=eaf.trait,
	allele1=allele1,allele2=allele2,
	instruments.file=instruments.file,
	liftover.dir="/projects/MRC-IEU/programs/twosampleMR/liftover/",
	gwas.dir="/projects/MRC-IEU/users/ph14916/GWAS_summary_data/",build.plus.strand.same=F)

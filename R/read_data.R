...
#' @param pval_col Required for enrichment tests. Name of column with p-values.
#' @param units_col Optional column name containing units.
#' @param ncase_col Optional column name containing number of cases.
#' @param ncontrol_col Optional column name containing number of controls.
#' @param samplesize_col Optional column name containing sample size.

...
Reads in outcome data. Checks and organises columns for use with MR or
...
- snps:
  ...
  SNPs to extract. If `NULL`, which the default, then doesn't extract
  any and keeps all.

- sep:

  Specify delimiter in file. The default is space, i.e. `sep=" "`.

...
![here](images/twosamplemr_schematic_long-01.png)
...
```{r eval=TRUE}
bmi_file <- system.file("example_data/bmi.txt", package="TwoSampleMR")
```
...
```{r }
bmi2_file <- system.file("example_data/bmi.csv", package="TwoSampleMR")
```

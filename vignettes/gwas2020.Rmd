...
- gwas2vcf online tool, allowing users to create GWAS VCF files from summary data: http://ieu-db-interface.epi.bris.ac.uk:8400/ (Functional, under construction?)
...
To update the package just run the `devtools::install_github("MRCIEU/TwoSampleMR")` command again.
